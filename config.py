...
HARDCODED_AGENCY = "Geron Engineering"
HARDCODED_SITE = "Geron Giddalur"
HARDCODED_USER = "admin"
HARDCODED_PASSWORD = "admin" 
HARDCODED_SITEMANAGER = "Sai"
WEIGHT_TOLERANCE = 1.0  # kg - adjust for your needs
STABLE_READINGS_REQUIRED = 1  # readings - adjust for stability vs responsiveness
